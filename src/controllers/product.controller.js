...
class ProductController {
  ...
  updateProduct = async (req, res, next) => {
    new SuccessResponse({
      message: "Product update successfully - Success Response",
  ...
  searchAllProducts = async (req, res, next) => {
    new SuccessResponse({
      ...
      metadata: await productService.searchAllProducts({...req.query, filter: req.body}),
    }).send(res);
  };
  ...
  getProductDetail = async (req, res, next) => {
    new SuccessResponse({
      ...
      metadata: await productService.getProductDetail(req.params),
    }).send(res);
  };
}
